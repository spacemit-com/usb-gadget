...
/* On Bianbu: gcc -g -o aio_simple aio_simple.c -laio */
...
static const struct {
	...
	} __attribute__ ((__packed__)) os_compat;
	struct {
		struct usb_os_desc_header header;
		struct usb_ext_prop_desc desc;
		__u8  bPropertyName[20];
		__le32 wPropertyDataLength;
		__u8  bPropertyData[39];
	} __attribute__ ((__packed__)) os_prop;
    ...
    .os_prop = {
        ...
        .bPropertyData =  "{E185CD43-BF09-F5D3-016B-BB5A12FCCB03}\0",
    },
};
